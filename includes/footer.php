    ...
    <div class="container">
        <div class="footer-grid">
            <div>
                ...
                <p class="footer-desc">Membangun ekosistem padel modern bagi komunitas yang berjiwa muda dan berprestasi.</p>
            ...
            <div>
                <h4>Newsletter</h4>
                <p class="footer-desc" style="margin-bottom:14px;">Dapatkan info promo &amp; jadwal lapangan terbaru setiap minggunya.</p>
                <form class="footer-newsletter" onsubmit="return false;">
                    <input type="email" placeholder="Email kamu">
                    <button type="submit" aria-label="Subscribe"><span class="material-symbols-outlined">send</span></button>
                </form>
            </div>
        </div>
