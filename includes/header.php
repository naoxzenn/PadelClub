...
<body class="<?= (isset($_SESSION['role']) && ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'kasir')) ? 'dashboard-body' : '' ?>">
        ...
        <aside class="dashboard-sidebar">
            ...
            <nav class="sidebar-nav">
                <?php if ($_SESSION['role'] === 'admin'): ?>
                    <a href="<?= $baseUrl ?? '' ?>admin/dashboard.php" class="<?= $currentPage === 'dashboard.php' && !isset($_GET['tab']) && strpos($_SERVER['REQUEST_URI'], '/admin/') !== false ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">dashboard</span> Dashboard
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>admin/dashboard.php?tab=booking" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'booking' ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">calendar_month</span> Booking
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>admin/dashboard.php?tab=users" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'users' ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">groups</span> Customers
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>admin/dashboard.php?tab=lapangan" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'lapangan' ? 'active' : '' ?>">
                    ...
                    <a href="<?= $baseUrl ?? '' ?>admin/dashboard.php?tab=payment" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'payment' ? 'active' : '' ?>">
                ...
                <?php elseif ($_SESSION['role'] === 'kasir'): ?>
                    <a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php" class="<?= $currentPage === 'dashboard.php' && !isset($_GET['tab']) && strpos($_SERVER['REQUEST_URI'], '/kasir/') !== false ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">dashboard</span> Dashboard
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php?tab=booking-confirm" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'booking-confirm' ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">check_circle</span> Booking
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php?tab=payment" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'payment' ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">payments</span> Pembayaran
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php?tab=receipt" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'receipt' ? 'active' : '' ?>">
                        <span class="material-symbols-outlined">receipt</span> Cetak Struk
                    </a>
                    <a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php?tab=profil" class="<?= isset($_GET['tab']) && $_GET['tab'] === 'profil' ? 'active' : '' ?>">
...
<?php else: ?>
    ...
    <nav class="nav" id="main-nav">
        ...
        <ul class="nav-links">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <?php if ($_SESSION['role'] === 'admin'): ?>
                    <li><a href="<?= $baseUrl ?? '' ?>admin/dashboard.php" class="<?= $currentPage === 'dashboard.php' && strpos($_SERVER['REQUEST_URI'], '/admin/') !== false ? 'active' : '' ?>">Dashboard Admin</a></li>
                <?php elseif ($_SESSION['role'] === 'kasir'): ?>
                    <li><a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php" class="<?= $currentPage === 'dashboard.php' && strpos($_SERVER['REQUEST_URI'], '/kasir/') !== false ? 'active' : '' ?>">Dashboard Kasir</a></li>
                <?php else: ?>
    ...
    <nav class="mobile-nav" id="mobile-nav" aria-label="Mobile navigation">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <?php if ($_SESSION['role'] === 'admin'): ?>
                <a href="<?= $baseUrl ?? '' ?>admin/dashboard.php" class="<?= $currentPage === 'dashboard.php' && strpos($_SERVER['REQUEST_URI'], '/admin/') !== false ? 'active' : '' ?>">
                    <span class="material-symbols-outlined">dashboard</span> Dashboard Admin
                </a>
            <?php elseif ($_SESSION['role'] === 'kasir'): ?>
                <a href="<?= $baseUrl ?? '' ?>kasir/dashboard.php" class="<?= $currentPage === 'dashboard.php' && strpos($_SERVER['REQUEST_URI'], '/kasir/') !== false ? 'active' : '' ?>">
