...
<head>
    ...
    <title>Restore Database Berhasil</title>
    <style>
        ...
        .warning-text { font-size: 12px; color: #991B1B; line-height: 1.5; background-color: #FEF2F2; border-radius: 8px; padding: 16px; border: 1px solid #FCA5A5; margin-top: 30px; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .warning-text { background-color: #7F1D1D !important; border-color: #EF4444 !important; color: #FCA5A5 !important; }
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="welcome-text">Kami ingin menginformasikan bahwa proses pemulihan (restore) database PadelClub telah selesai dilaksanakan dengan sukses. Keadaan database telah dikembalikan sesuai file cadangan berikut:</p>
                
                <div class="details-card">
                    <div class="details-row">
                        <span class="label">Nama File Sumber</span>
                ...
                <div class="warning-text">
                    <strong>PENTING:</strong> Seluruh data transaksi atau perubahan setelah tanggal backup di atas telah digantikan secara permanen oleh data restore ini.
                </div>
            </div>
            <div class="footer">
