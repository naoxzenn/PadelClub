...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; background-color: #22C55E; color: #FFFFFF !important; text-decoration: none; padding: 14px 28px; border-radius: 9999px; font-weight: bold; font-size: 14px; }
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="welcome-text">Terima kasih telah mendaftar di PadelClub Premium! Silakan verifikasi alamat email Anda dengan mengklik tombol di bawah ini:</p>
                ...
                <p class="welcome-text" style="font-size: 13px; word-break: break-all;"><a href="<?= $verification_link ?>" style="color: #0EA5E9;"><?= $verification_link ?></a></p>

                <div class="warning-text">
                    Jika Anda tidak melakukan pendaftaran akun di PadelClub Premium, Anda dapat mengabaikan email ini dengan aman.
                </div>
            </div>
            <div class="footer">
