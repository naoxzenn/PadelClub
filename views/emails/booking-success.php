...
<head>
    ...
    <title>Booking Lapangan Berhasil dibuat</title>
    <style>
        ...
        .btn { display: inline-block; background-color: #0EA5E9; color: #FFFFFF !important; text-decoration: none; padding: 12px 24px; border-radius: 9999px; font-weight: bold; font-size: 14px; }
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p class="welcome-text">Pemesanan lapangan Padel Anda berhasil dibuat dan saat ini sedang menunggu pembayaran/verifikasi. Berikut adalah rincian pesanan Anda:</p>
                ...
                <p class="welcome-text" style="font-size: 14px; color: #64748B;">Silakan selesaikan pembayaran dan unggah bukti transfer di menu dashboard jika Anda memilih metode transfer bank agar jadwal lapangan Anda segera dikonfirmasi.</p>
                
                <div class="btn-wrapper">
                    <a href="<?= $_ENV['APP_URL'] ?>/dashboarduser.php" class="btn">Lihat Riwayat Booking</a>
                </div>
            </div>
            <div class="footer">
