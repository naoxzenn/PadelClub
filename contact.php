...
<section class="page-header">
    <div class="container">
        <div class="fade-up">
            <span
                style="display:inline-flex; align-items:center; gap:8px; font-size:.75rem; font-weight:700; letter-spacing:.1em; text-transform:uppercase; color:var(--blue); margin-bottom:12px;">
    ...
    <div class="container">
            ...
            <div class="contact-info-card fade-up">
                ...
                <div class="contact-info-item">
                    ...
                    <div>
                        ...
                        <span>Jl. Tulang Bawang Sel. No.26, Kadipiro, <br>Kec. Banjarsari,Kota Surakarta, Jawa Tengah
                            57136</span>
                    </div>
                </div>
                ...
                <div style="margin-top:32px; position:relative; z-index:1;">
                    <p
                        style="font-size:.78rem; font-weight:700; letter-spacing:.08em; text-transform:uppercase; color:rgba(255,255,255,.4); margin-bottom:14px;">
                        Ikuti Kami</p>
                ...
                <form id="contact-form" novalidate>
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="cf-name" name="name" placeholder="Nama lengkap Anda"
                                autocomplete="name">
                            <div class="field-error" id="err-name">Nama wajib diisi.</div>
                        </div>
                        <div class="form-group">
                            <label for="cf-email">Email <span style="color:#EF4444;">*</span></label>
                            <input type="email" id="cf-email" name="email" placeholder="email@contoh.com"
                                autocomplete="email">
        ...
        <div class="map-embed fade-up">
            <iframe
                ...
                title="Lokasi PadelClub — Universitas Muhammadiyah PKU Surakarta"></iframe>
        </div>
    </div>
</section>
...
<section class="container" style="padding-bottom:64px;">
    <div class="cta-banner fade-up">
        ...
        <a href="<?= isset($_SESSION['user_id']) && $_SESSION['role'] === 'customer' ? 'booking.php' : 'register.php' ?>"
